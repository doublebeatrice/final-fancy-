...
const OUT = path.join(ROOT, 'data', 'actions', 'ru2438_juneteenth_table_keyword_append_2026-06-08.json');
...
const PLAN = {
  ...
  campaignName: 'ai_kw broad_b2b juneteenth table decorations_ru2438',
  groupName: 'ai_kw broad_b2b juneteenth table decorations_ru2438',
  matchType: 'BROAD',
  bid: 0.42,
  terms: [
