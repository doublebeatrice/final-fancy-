...
const OUT = path.join(ROOT, 'data', 'actions', 'kz5816_b2b_kw_group_2026-06-08.json');
...
const PLAN = {
  ...
  siteId: 4,
  mode: 'keywordTarget',
  campaignName: 'b2b kw broad_cinema party decorations_kz5816',
  groupName: 'b2b kw broad_cinema party decorations_kz5816',
  coreTerm: 'cinema party decorations',
  matchType: 'BROAD',
  dailyBudget: 3,
  defaultBid: 0.40,
  keywords: [
    'in my theatre era decor',
    'large 1920s theme',
    'cinema party decorations',
    'film festival party supplies',
    'now showing sign',
  ],
};
...
async function main() {
  ...
  try {
    ...
    const out = {
      ...
      diagnosis: 'KZ5816 B2B auto produced buyer-facing ordered terms; create SP B2B broad keyword lane using only ordered terms from B2B auto and same-SKU proven movie/VIP terms.',
      bidEvidence: {
        sku7dCpc: 0.3668,
        sku30dCpc: 0.4079,
        b2bAuto30dCpc: 0.33,
        source: 'live KZ5816 SKU summary and B2B auto readback on 2026-06-08',
      },
      plan: PLAN,
      dryRun: built,
      execution: {
